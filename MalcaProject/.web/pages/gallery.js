...
return (
<Center sx={{"min-height": "100vh", "display": "flex", "flex-direction": "column", "justify-content": "center", "bgColor": "gray.50"}}><Container sx={{"display": "flex", "flex-direction": "column", "align-items": "center", "bgColor": "white", "padding": "2em", "shadow": "lg", "borderRadius": "lg"}}><Heading sx={{"align": "center"}}>{`Gallery`}</Heading>
<Container sx={{"display": "flex", "gap": "1em", "margin": "2em", "justifyContent": "center"}}><Container><Image src="https://picsum.photos/300/200"
